                ...
                <div class="col-md-8">
                    <div class="user-menu">
                        <ul>
                            ...
                            <li><a href="checkout.jsp"><i class="fa fa-user"></i> 查看</a></li>
    ...
    <div class="site-branding-area">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <div class="logo">
                        <h1><a href="./"><img src="/project_training/img/logo.png"></a></h1>
                    </div>
                </div>
                        ...
                        <div class="product-carousel">
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="${ctx}/cart/add?id=1&userid=${user.getId()}" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> 添加到购物车</a>
                                        <a href="${ctx}/product/single?id=1" class="view-details-link"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                                
                                <h2><a href="single-product.html">三星Galaxy s5</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        ...
                                        <a href="single-product.html" class="view-details-link" id="2"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> 添加到购物车</a>
                                        <a href="single-product.html" class="view-details-link" id="3"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> 添加到购物车</a>
                                        <a href="single-product.html" class="view-details-link" id="4"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                                
                                <h2><a href="single-product.html">索尼微软</a></h2>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> 添加到购物车</a>
                                        <a href="single-product.html" class="view-details-link" id="5"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    ...
                                    <div class="product-hover">
                                        <a href="#" class="add-to-cart-link"><i class="fa fa-shopping-cart"></i> 添加到购物车</a>
                                        <a href="single-product.html" class="view-details-link" id="6"><i class="fa fa-link"></i> 查看具体信息</a>
                                    </div>
                                </div>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            ...
                            <h2><a href="single-product.html">苹果新mac书 2015</a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                ...
                <div class="col-md-4">
                    <div class="single-product-widget">
                        ...
                        <div class="single-wid-product">
                            ...
                            <h2><a href="single-product.html">索尼 playstation微软</a></h2>
                            <div class="product-wid-rating">
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
                                <i class="fa fa-star"></i>
